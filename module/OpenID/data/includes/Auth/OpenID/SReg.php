...
$Auth_OpenID_sreg_data_fields = array(
                                      ...
                                      'public_id' => 'Идентификатор системы ID.UZ',
                                      'personal_number' => 'Персональный идентификационный номер физического лица',
                                      'userid'   => 'UserID',
                                      'status'  => 'Status',
                                      'phone'   => 'Phone',
                                      'passport_sn' => 'Passport serial number',
                                      'passport_issued' => 'Passport issued',
                                      'passport_issued_date' => 'Passport issued date',
                                      'passport_address'=> 'Passport address',
                                      'passport_exp' => 'Passport expire',
                                      'region'=>'Регион',
                                      'microregion'=>'Район',
                                      'home_addr'=>'Место жительства',                                      
    );
